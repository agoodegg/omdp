...
$(function() {
	...
	$("#btnSave").bind('click',function(){
		if(CheckForm()){
			$("body").mask("信息提交中...");
			$.ajax({
			    url: '<%=path %>/order/ot-newOrder/saveNewOrder.htm',
			    type: 'POST',
			    timeout: 2000,
			    	...
			    	if(json){
			    		try{
			    			...
			    			if(jsondata.success===true){
				    			noDirty();
				    			alert(jsondata.msg);
				    			window.location.replace("<%=path %>/order/ot-orderQuery/queryAll.htm");
...
<th colspan="6"><span style="float:left;">增加新OT单(<font color="#ff0000">*</font>号为必填项)</span><span style="float:right;" title="工单编号自动生成"><span class="numclass">No:</span><span class="numclasscontent">......&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></th>
<tr>
		<td width="10%" align="center" nowrap>客户名称<font color="#ff0000">*</font>：</td>
		...
		<input type="button" name="new" id="newBtn" value="新客户"> <input type="hidden" name="dispatchOther" id="dispatchOther" value="1"/>
	...
	<tr id="outInfoArea">
		...
		<td width="25%"><input name="dispatchName" id="dispatchName" type="text" value="" />	</td>
		<td width="10%" align="center" nowrap>供货商电话<font color="#ff0000">*</font>：</td>
		<td width="25%"><input name="agentMobile" type="text" value="" id="agentMobile"  onKeyPress="inputInteger();"  onbeforepaste="pasteInteger();" />
		</td>
		<td align="center" nowrap>供货商地址:</td><td><input name="agentAddress" type="text" value="" id="agentAddress"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="10%" align="center" nowrap>印刷要求(详细描述)<font color="#ff0000">*</font>：</td>
		<td colspan="5" height="40"><textarea name="printMemo" width="100%" height="100%" style="width:100%;height:100%;"></textarea></td>
	</tr>
	<tr>
		<td width="10%" align="center" nowrap>排版人员：<input type="hidden" name="typesetOpr" id="typesetOpr"/></td>
