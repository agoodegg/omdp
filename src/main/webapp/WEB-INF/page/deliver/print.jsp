...
<form name="form1" action="" style="padding-top:4px;margin-top:9px;margin-left:2px;width:100%">
<center>
<table border="0" width="95%" style="border-collapse:collapse;" align="center" >
	<tr height="30pt">
		<td align="center" style="font-size:22px;font-family:黑体;font-weight:bold;" colspan="10">
			<font color='#000000'>深圳市欧美数码印务有限公司</font><br/>
			<span style="line-height:20px;font-size:18px;">送货清单</span>
		</td>
	</tr>
	<tr>
...
<div class="makebill">
<table align="center" width="100%" cellpadding="0" style="border-top-style:none;border-bottom-style:none;border-right-style:none;" cellspacing="0" class="tabp" height="300">
...
<tr height="20px"><td style="border-bottom-style:none;border-left-style:none;" valign="bottom">
	<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse; border-top-style:none; border-bottom-style:none; border-left-style:none;border-right-style:none" >
		...
		<tr align="center" height='20px'>
			<td width="8%" style="font-size:14px;border-left-style:none;font-weight:bold;">合计:</td>
...
<table border="0" style="margin:10 0 0 0;" cellpadding="0" cellspacing="0" width="100%">
<tr>
<td align="center" style="font-size:23px;font-family:宋体;font-weight:bold;">数码印刷&nbsp;&nbsp;&nbsp;&nbsp;装订专家</td>
</tr>
<tr height="30">
<td align="center" style="font-size:13px;font-family:宋体;">24小时服务热线：0755-26551959、26551973、26551978、26551987</td>
</tr>
<tr>
<td align="center" style="font-size:13px;font-family:宋体;">Email：ypvv@163.net&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址：深圳市科技园南区综合服务楼一楼(肯德基西侧)</td>
</tr>
</table>
</FORM>
