...
<html>
<head>
	<title>订单-【${order.ordernum}】结算详细</title>
...
<div style="margin:10 0 0 0;background:#efae41;font-size:27;font-weight:bold;">★☆已结算</div>
...
<div style="margin:10 0 0 0;background:#acf37c;font-size:27;font-weight:bold;color:ff0000;">
<c:choose>
<c:when test="${trad.validStatus=='0'}">
★★☆已核销
</c:when>
<c:otherwise>
★★☆未核销
...
<tr>
		...
		<td colspan="5">${trad.validComm}
		</td>
	</tr>
	<tr>
		<td width="15%" align="center">核销人：</td>
		<td width="17%">${trad.validOprName}
		</td>
		<td width="15%" align="center">核销时间：</td>
		<td width="17%"><fmt:formatDate  value="${trad.validTime}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate >
		</td>
		<td colspan="2">
		&nbsp;
		</td>
	...
	<tr>
		...
		<input style="font-size:17px;color:#0000cf;font-weight:bold;" type="button" onclick="window.close()" value="关 闭">
		</td>
	</tr>
</table>
</form>
