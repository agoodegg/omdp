			...
			$.ajax({
			    ...
			    success: function(json){
			    	...
			    	if(json){
			    		if(json.success){
				    		alert(json.msg);
				    		window.location.replace("<%=path %>/customer/customerManage/queryCustomer.htm");
				    	}
				    	else{
				    		alert(json.msg);
				    	}
...
<div id="main" class="mainPanel wd txt_left">
	<div class="titleInfo">							
			<h3 class="left">新增客户</h3><span class="addrtitle b_size"></span>					
			</div>
...
<table cellspacing="0" align="center" class="infoTable domainInfo listTable" style="width:100%;margin:0 0 0 0;padding:0 0 0 0;">
	...
	<tr>
		...
		<td width="23"><input name="linkMan" type="text" value=""  dataType="LimitB" max="40" msg="联系人(长度小于40)"/></td>
		<td width="10%" align="center" nowrap>联系电话：</td>
		<td width="23"><input name="mobileNo" type="text" value="" id="mobileNo" onKeyPress="inputInteger();"  onbeforepaste="pasteInteger();"  dataType="LimitB" min="1"  max="40" msg="联系电话(非空,长度小于40)"/>
		</td>
		<td width="10%" align="center" nowrap>传真：</td>
		<td width="24"><input name="fax" type="text" value="" id="fax" onKeyPress="inputInteger();"  onbeforepaste="pasteInteger();" dataType="LimitB"  max="40" msg="传真(长度小于40)"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="10%" align="center" nowrap>结算周期：</td>
		<td width="23">
		<o:select headValue="" headText="---请选择---" name="payCycle" type="payCycle"  dataType="LimitB"  max="20" msg="结算周期(长度小于20)"></o:select>
		</td>
	...
	<tr>
		...
		<td width="23"><input name="webSite" type="text" value="" id="webSite" dataType="LimitB"  max="80" msg="公司网站(长度小于80)"/>
		</td>
	...
	<tr>
		...
		<textarea name="intro" style="width:100%;height:100%;" dataType="LimitB"  max="120" msg="简介及备注(长度小于120)"></textarea>
		</td>
	</tr>
	</table>
</div></form>
