...
Ext.onReady(function(){
	...
	setTimeout(function(){
	 ...
	 Ext.get('addContractBtn').on('click',function(){
 		...
 		Ext.Ajax.request({
 			url: '<%=path %>/contract/doContractAdd.htm',
...
<form id="addContractForm">
	<div class="WordSection1">
				...
				<td>
					<div class="content_1" style="font-size:15px;font-weight:bold;margin:10px 0 0 0;font-family: web-font-bold;">
						<ul style="list-style-type:none;">
							<li><span class="ctitle" style="font-size:15px;font-weight:bold;font-family:Arial,sans-serif;">Contract No.合同编号：</span><input  width="239" style="width:239px;" id="contractNoId" value="编号自动生成..." style="color:c21111;background:#c1c1c1;" readOnly="true"  onfocus="javascript:blur();"  dataType="LimitB" min="1"  max="20" msg="合同编号(非空,长度小于20)" /></li>
							<li><span class="ctitle" style="font-size:15px;font-weight:bold;font-family:Arial,sans-serif;">甲方（委托方）：</span><input name="buyer" width="280" style="width:280px;" id="buyerId" dataType="LimitB" min="1"  max="80" msg="甲方（委托方）(非空,长度小于40)" /></li>
		...
		<table class="suTable" border="1" cellspacing="0" cellpadding="0" style="width:100%;">
			<tr>
				<td>包&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;装：<input name="package_" value="牛皮纸包装"  width="220" style="width:220px;" dataType="LimitB"  max="200" msg="包装(长度小于100)"/></td><td rowspan="2">付款方法：<input name="payChannel" width="220" style="width:220px;" dataType="LimitB"  max="100" msg="付款方法(长度小于50)"/></td>
			</tr>
			<tr>
				<td>交货地点：<input name="deliverPlace"   width="220" style="width:220px;" dataType="LimitB"  max="120" msg="交货地点(长度小于60)"/></td>
			</tr>
			<tr>
				<td colspan="2">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：<input name="memo"  width="570" style="width:570px;" value="以上价格含税，（普通发票），含运费、打包费"  dataType="LimitB"  max="240" msg="备注(长度小于120)"/></td>
			</tr>
		</table>
		...
		<table class="footer" width="100%;">
			<tr>
			<td width="75">甲&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;方:</td><td><input width="220" style="width:220px;"/></td><td width="35">&nbsp;</td>
			<td width="75">乙&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;方:</td><td>深圳市欧美数码印务有限公司</td>
		  </tr>
		  <tr>
			<td width="75">单位地址:</td><td><input name="buyerAddress"  width="220" style="width:220px;" dataType="LimitB"  max="120" msg="甲方单位地址(长度小于60)"/></td><td width="35">&nbsp;</td>
			<td width="75">单位地址:</td><td>深圳南山区科技园南区C1栋一楼</td>
		  </tr>
			<tr>
			<td width="75">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话:</td><td><input name="buyerTel"   width="220" style="width:220px;" dataType="LimitB"   max="40" msg="甲方电话(长度小于20)"/></td><td width="35">&nbsp;</td>
			<td width="75">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话:</td><td>0755-89808638</td>
		  </tr>
		  <tr>
			<td width="75">传&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;真:</td><td><input name="buyerFax"   width="220" style="width:220px;" dataType="LimitB"  max="40" msg="甲方传真(长度小于20)"/></td><td width="35">&nbsp;</td>
			<td width="75">传&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;真:</td><td>0755-26551973</td>
		  </tr>
		  <tr>
			<td width="75">开户银行:</td><td><input name="buyerAccountBank"   width="220" style="width:220px;" dataType="LimitB"  max="60" msg="甲方开户银行(长度小于30)"/></td><td width="35">&nbsp;</td>
			<td width="75">开户银行:</td><td>深圳平安银行高新区支行</td>
		  </tr>
		  <tr>
			<td width="75">帐&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号:</td><td><input name="buyerAccountNo"   width="220" style="width:220px;" dataType="LimitB"  max="40" msg="甲方帐号(长度小于20)"/></td><td width="35">&nbsp;</td>
			<td width="75">帐&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号:</td><td>0412100133030</td>
		  </tr>
		  <tr>
			<td width="75">甲方代表:</td><td><input name="buyerMan"   width="220" style="width:220px;" dataType="LimitB"  max="40" msg="甲方代表(长度小于20)"/></td><td width="35">&nbsp;</td>
			<td width="75">乙方代表:</td><td><input name="sellerMan"   width="220" style="width:220px;"/></td>
		  </tr>
		  <tr>
			<td width="75">日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;期:</td><td><input name="buyerDateStr" value="${nowDate}"  width="220" style="width:220px;"/></td><td width="35">&nbsp;</td>
			<td width="75">日&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;期:</td><td><input name="sellerDateStr" value="${nowDate}"  width="220" style="width:220px;"/></td>
		  </tr>
		</table>
	</div>
...
<tr>
<td align="center" style="text-align:center;"><input type="button" value="保  存" id="addContractBtn"/></td>
</tr>
</table>
</body>
</html>
