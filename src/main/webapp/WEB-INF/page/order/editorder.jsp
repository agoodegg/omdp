...
$(function() {
	...
	$("#btnSave").bind('click',function(){
		if(CheckForm()){
			$("body").mask("信息提交中...");
			$.ajax({
			    url: '<%=path %>/order/newOrder/updateOrder.htm',
			    type: 'POST',
			    timeout: 2000,
...
<th colspan="6"><span style="float:left;">修改工单(<font color="#ff0000">*</font>号为必填项)</span><span style="float:right;" title="工单编号"><span class="numclass">工单编号No:</span><span class="numclasscontent">${order.ordernum}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></span></th>
<tr>
