...
public class TOrderDetail implements java.io.Serializable {
	...
	/** minimal constructor */
	public TOrderDetail(String ordernum, String itemType, String itemName, Double total, String unit) {
	...
	/** full constructor */
	public TOrderDetail(String ordernum, String itemType, String itemName, String itemCode, String filePath,
			Double amount, String expression, Double unitPrice, Double total, String unit, String request,
			String esp1, String code1, String esp2, String code2, String esp3, String code3, String esp4, String code4,
			Float complete, String completeExp) {
		this.ordernum = ordernum;
		this.itemType = itemType;
		this.itemName = itemName;
