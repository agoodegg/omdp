...
@Controller
@Scope("prototype")
public class NewOrderAction extends AbstractController {

	private final static String NEW_ORDER_PAGE = "order/neworder";
	private final static String NEW_ORDER_DETAIL_PAGE = "order/neworderdetail";
	
	private final static String SEL_CUSTOMER = "order/selcustomer";
	private final static String SEL_CUSTOMER_IN = "order/selcustomerin";
	...
	@RequestMapping("/order/newOrder/toNewOrder.htm")
	...
	@RequestMapping("/order/newOrder/toNewOrderDetail.htm")
	...
	@RequestMapping("/order/newOrder/saveOrderDetail.htm")
	...
	@RequestMapping("/order/newOrder/updateOrderDetail.htm")
	...
	@RequestMapping("/order/newOrder/delOrderDetail.htm")
	...
	@RequestMapping("/order/newOrder/saveNewOrder.htm")
	...
	@RequestMapping("/order/newOrder/updateOrder.htm")
...
//		}
	...
	//客户姓名自动完成
	@RequestMapping("/order/newOrder/queryCustomer.htm")
	...
	@RequestMapping("/order/newOrder/selCustomer.htm")
	public ModelAndView selCustomer(HttpServletRequest request, HttpServletResponse response){
		Authentication auth = SecurityContextHolder.getContext().getAuthentication();
		TUser u = (TUser)(auth.getPrincipal());
		...
		return new ModelAndView(SEL_CUSTOMER,mode);
	}
	
	@RequestMapping("/order/newOrder/selCustomerIn.htm")
	public ModelAndView selCustomerIn(HttpServletRequest request, HttpServletResponse response,@ModelAttribute("page")Page page,@ModelAttribute("cust")TCustInfo cust){
		Authentication auth = SecurityContextHolder.getContext().getAuthentication();
		TUser u = (TUser)(auth.getPrincipal());
		
		page.setPageSize(15);
		List<TCustInfo> custList = nService.queryUserInfoList(cust, page, u);
		
		Map<String, Object> modle = new HashMap<String, Object>();  
		modle.put("user", u);
		modle.put("custList", custList);
		modle.put("page", page);
		modle.put("q", cust);
		
		
		return new ModelAndView(SEL_CUSTOMER_IN,modle);
	}
}
